...
class AdminCreateEventDialog extends StatefulWidget {
  const AdminCreateEventDialog({
    Key? key,
    required this.firstDay,
    required this.lastDay,
    required this.selectedDay,
  ...
  @override
  State<AdminCreateEventDialog> createState() => _AdminCreateEventDialogState();
}

class _AdminCreateEventDialogState extends State<AdminCreateEventDialog> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  final TextEditingController _dayController = TextEditingController();
  final TextEditingController _startTimeController = TextEditingController();
  final TextEditingController _endTimeController = TextEditingController();
