...
const profileSelectionText = 'Select Subscription Profile';
const profileCreationText = 'Add subscription';

const nextText = 'Next';
const submitText = 'Submit';
const lastNameLabelText = 'Last Name';
const lastNameHintText = 'Enter student\'s last name';
const lastNameValidateText = 'Please enter student\'s last name';
